...
(def palettes
  ...
  (map (fn [palette]
       ...
       [{:name "frozen-rose" :colors ["#29368f" "#e9697b" "#1b164d" "#f7d996"] :background "#f2e8e4"}
        ...
        {:name "olympia" :colors ["#ff3250" "#ffb33a" "#008c36" "#0085c6" "#4c4c4c"] :stroke "#0b0b0b" :background "#faf2e5"}
        {:name "byrnes" :colors ["#c54514" "#dca215" "#23507f"] :stroke "#0b0b0b" :background "#e8e7d4"}
        {:name "butterfly" :colors ["#f40104" "#f6c0b3" "#99673a" "#f0f1f4"] :stroke "#191e36" :background "#191e36"}
        {:name "floratopia" :colors ["#bf4a2b" "#cd902a" "#4e4973" "#f5d4bc"] :stroke "#1e1a43" :background "#1e1a43"}
        {:name "verena" :colors ["#f1594a" "#f5b50e" "#14a160" "#2969de" "#885fa4"] :stroke "#1a1a1a" :background "#e2e6e8"}
        {:name "empusa" :colors ["#c92a28" "#e69301" "#1f8793" "#13652b" "#e7d8b0" "#48233b" "#e3b3ac"] :stroke "#1a1a1a" :background "#f0f0f2"}
        {:name "florida_citrus" :colors ["#ea7251" "#ebf7f0" "#02aca5"] :stroke "#050100" :background "#9ae2d3"}
        {:name "lemon_citrus" :colors ["#e2d574" "#f1f4f7" "#69c5ab"] :stroke "#463231" :background "#f79eac"}
        {:name "yuma_punk" :colors ["#f05e3b" "#ebdec4" "#ffdb00"] :stroke "#ebdec4" :background "#161616"}
        {:name "moir" :colors ["#a49f4f" "#d4501e" "#f7c558" "#ebbaa6"] :stroke "#161716" :background "#f7f4ef"}
        {:name "tokyo" :colors ["#d13821" "#1d295b" "#51587d" "#e7e7e7"] :stroke "#0b0e3e" :background "#c7b09e"}
        {:name "bauhaus01" :colors ["#ea542f" "#f19c1b" "#4f8ba9"] :stroke "#221e1f" :background "#e7dbc4"}
        {:name "bauhaus02" :colors ["#bb2f2a" "#e9b500" "#0165b7"] :stroke "#000000" :background "#e5d6b8"}
        ...
        {:name "cc242" :colors ["#bbd444" "#fcd744" "#fa7b53" "#423c6f"] :background "#faf4e4"}
        {:name "cc245" :colors ["#0d4a4e" "#ff947b" "#ead3a2" "#5284ab"] :background "#f6f4ed"}
        {:name "cc273" :colors ["#363d4a" "#7b8a56" "#ff9369" "#f4c172"] :background "#f0efe2"}
        {:name "rag-mysore" :colors ["#ec6c26" "#613a53" "#e8ac52" "#639aa0"] :background "#d5cda1"}
        {:name "rag-gol" :colors ["#d3693e" "#803528" "#f1b156" "#90a798"] :background "#f0e0a4"}
        {:name "rag-belur" :colors ["#f46e26" "#68485f" "#3d273a" "#535d55"] :background "#dcd4a6"}
        {:name "rag-bangalore" :colors ["#ea720e" "#ca5130" "#e9c25a" "#52534f"] :background "#f9ecd3"}
        ...
        {:name "tundra2" :colors ["#5f9e93" "#3d3638" "#733632" "#b66239" "#b0a1a4" "#e3dad2"]}
        {:name "tundra3" :colors ["#87c3ca" "#7b7377" "#b2475d" "#7d3e3e" "#eb7f64" "#d9c67a" "#f3f2f2"]}
        {:name "tundra4" :colors ["#d53939" "#b6754d" "#a88d5f" "#524643" "#3c5a53" "#7d8c7c" "#dad6cd"]}
        {:name "rohlfs_1R" :colors ["#004996" "#567bae" "#ff4c48" "#ffbcb3"] :stroke "#004996" :background "#fff8e7"}
        {:name "rohlfs_1Y" :colors ["#004996" "#567bae" "#ffc000" "#ffdca4"] :stroke "#004996" :background "#fff8e7"}
        ...
        {:name "ducci_e" :colors ["#c37c2b" "#f6ecce" "#000000" "#386a7a"] :stroke "#386a7a" :background "#e3cd98"}
        ...
        {:name "ducci_j" :colors ["#c47c2b" "#5f5726" "#000000" "#7e8a84"] :stroke "#7e8a84" :background "#ecddc5"}
        {:name "ducci_o" :colors ["#c15e1f" "#e4a13a" "#000000" "#4d545a"] :stroke "#4d545a" :background "#dfc79b"}
        ...
        {:name "ducci_v" :colors ["#c65f75" "#d3990e" "#000000" "#597e7a"] :stroke "#597e7a" :background "#f6eccb"}
        {:name "ducci_x" :colors ["#dd614a" "#f5cedb" "#1a1e4f"] :stroke "#1a1e4f" :background "#fbb900"}
        {:name "jud_playground" :colors ["#f04924" "#fcce09" "#408ac9"] :stroke "#2e2925" :background "#ffffff"}
        {:name "jud_horizon" :colors ["#f8c3df" "#f2e420" "#28b3d0" "#648731" "#ef6a7d"] :stroke "#030305" :background "#f2f0e1"}
        {:name "jud_mural" :colors ["#ca3122" "#e5af16" "#4a93a2" "#0e7e39" "#e2b9bd"] :stroke "#1c1616" :background "#e3ded8"}
        {:name "jud_cabinet" :colors ["#f0afb7" "#f6bc12" "#1477bb" "#41bb9b"] :stroke "#020508" :background "#e3ded8"}
        {:name "iiso_zeitung" :colors ["#ee8067" "#f3df76" "#00a9c0" "#f7ab76"] :stroke "#111a17" :background "#f5efcb"}
        {:name "iiso_curcuit" :colors ["#f0865c" "#f2b07b" "#6bc4d2" "#1a3643"] :stroke "#0f1417" :background "#f0f0e8"}
        {:name "iiso_airlines" :colors ["#fe765a" "#ffb468" "#4b588f" "#faf1e0"] :stroke "#1c1616" :background "#fae5c8"}
        {:name "iiso_daily" :colors ["#e76c4a" "#f0d967" "#7f8cb6" "#1daeb1" "#ef9640"] :stroke "#000100" :background "#e2ded2"}
        {:name "kov_01" :colors ["#d24c23" "#7ba6bc" "#f0c667" "#ede2b3" "#672b35" "#142a36"] :stroke "#132a37" :background "#108266"}
        {:name "kov_02" :colors ["#e8dccc" "#e94641" "#eeaeae"] :stroke "#e8dccc" :background "#6c96be"}
        {:name "kov_03" :colors ["#e3937b" "#d93f1d" "#090d15" "#e6cca7"] :stroke "#090d15" :background "#558947"}
        {:name "kov_04" :colors ["#d03718" "#292b36" "#33762f" "#ead7c9" "#ce7028" "#689d8d"] :stroke "#292b36" :background "#deb330"}
        {:name "kov_05" :colors ["#de3f1a" "#de9232" "#007158" "#e6cdaf" "#869679"] :stroke "#010006" :background "#7aa5a6"}
        {:name "kov_06" :colors ["#a87c2a" "#bdc9b1" "#f14616" "#ecbfaf" "#017724" "#0e2733" "#2b9ae9"] :stroke "#292319" :background "#dfd4c1"}
        {:name "kov_06b" :colors ["#d57846" "#dfe0cc" "#de442f" "#e7d3c5" "#5ec227" "#302f35" "#63bdb3"] :stroke "#292319" :background "#dfd4c1"}
        {:name "kov_07" :colors ["#c91619" "#fdecd2" "#f4a000" "#4c2653"] :stroke "#111" :background "#89c2cd"}
        ...
        {:name "tsu_akasaka" :colors ["#687f72" "#cc7d6c" "#dec36f" "#dec7af" "#ad8470" "#424637"] :stroke "#251c12" :background "#cfc7b9"}
        ...
        {:name "dt03" :colors ["#000000" "#a7a7a7"] :stroke "#000000" :background "#0a5e78"}
        {:name "dt04" :colors ["#50978e" "#f7f0df"] :stroke "#000000" :background "#f7f0df"}
        ...
        {:name "dt07" :colors ["#6a98a5" "#d24c18"] :stroke "#efebda" :background "#efebda"}
        {:name "dt08" :colors ["#5d9d88" "#ebb43b"] :stroke "#efebda" :background "#efebda"}
        {:name "dt09" :colors ["#052e57" "#de8d80"] :stroke "#efebda" :background "#efebda"}
        {:name "hilda01" :colors ["#ec5526" "#f4ac12" "#9ebbc1" "#f7f4e2"] :stroke "#1e1b1e" :background "#e7e8d4"}
        {:name "hilda02" :colors ["#eb5627" "#eebb20" "#4e9eb8" "#f7f5d0"] :stroke "#201d13" :background "#77c1c0"}
        {:name "hilda03" :colors ["#e95145" "#f8b917" "#b8bdc1" "#ffb2a2"] :stroke "#010101" :background "#6b7752"}
        {:name "hilda04" :colors ["#e95145" "#f6bf7a" "#589da1" "#f5d9bc"] :stroke "#000001" :background "#f5ede1"}
